<?php
    ...
    if (isset($_POST['input_submit'])) {
        ...
        if ($rowselect) {
            $hapus = $rowselect['hapus'];
            if ($hapus == 1) {
                echo "<script>alert('Akun ini telah dihapus. Silakan hubungi administrator untuk informasi lebih lanjut.'); document.location='../index.php';</script>";
            } else {
                $row = $rowselect['role'];
