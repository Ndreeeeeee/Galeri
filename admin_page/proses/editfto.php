...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($_FILES["fto"]["name"])) {
        ...
        $sql = "UPDATE foto SET fto = '$targetFile', jdlfto = '$jdlfto', tglup = '$tglup', deskfto = '$deskfto' WHERE id_foto = $id_foto";
    } else {
        // Jika tidak ada file yang diunggah, hanya update data lainnya
        $sql = "UPDATE foto SET jdlfto = '$jdlfto', tglup = '$tglup', deskfto = '$deskfto' WHERE id_foto = $id_foto";
    }
